$(document).ready(function () {
   ...
   */
  $("#slickform").submit(function slickcontactparse() {
    ...
    // Values
    var successmessage =
      "Gracias por el correo electrónico, ¡nos pondremos en contacto pronto!";
    var failedmessage = "Hubo un problema. Vuelve a intentarlo.";
    var usersname = $("#name");
    ...
    if (usersemail.val() == "") {
      ...
      $(".errorcontainer").html("¡Por favor inserte su correo electrónico!");
    ...
    if (usersname.val() == "") {
      $(".slickbutton")
        ...
        .delay(6000)
        .animate({ marginTop: "0px" }, 1000);
      $(".errorcontainer").html("¡Por favor inserte su nombre!");
      $(".errorcontainer").delay(1200).fadeIn(1000).delay(4000).fadeOut(1000);
      $("input[type=submit]", $("#slickform")).removeAttr("disabled");
      return false;
    }
    ...
    if (usersphone.val() == "") {
      $(".slickbutton")
        ...
        .delay(6000)
        .animate({ marginTop: "0px" }, 1000);
      $(".errorcontainer").html("Introduzca su número de teléfono.");
      $(".errorcontainer").delay(1200).fadeIn(1000).delay(4000).fadeOut(1000);
      $("input[type=submit]", $("#slickform")).removeAttr("disabled");
      return false;
    }
    ...
    if (userscomment.val() == "") {
      $(".slickbutton")
        ...
        .delay(6000)
        .animate({ marginTop: "0px" }, 1000);
      $(".errorcontainer").html("¡Olvidaste dejar un mensaje!");
      $(".errorcontainer").delay(1200).fadeIn(1000).delay(4000).fadeOut(1000);
      $("input[type=submit]", $("#slickform")).removeAttr("disabled");
      return false;
    }
    ...
    $.post(
      url,
      {
        ...
        userssubject: userssubject.val(),
        userscomment: userscomment.val(),
        usershuman: usershuman.val(),
        isvalid: isvalid,
      },
      function (data) {
        if (data == "success") {
