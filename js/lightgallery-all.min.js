      ...
      (f.prototype.build = function () {
        ...
        e.core.$outer.find(".lg-thumb").html(f),
          ...
          d.each(function () {
            ...
            c &&
              a.getJSON(
                "https://www.vimeo.com/api/v2/video/" + c + ".json?callback=?",
                { format: "json" },
                function (a) {
      ...
      c.core.$el.on("onAferAppendSlide.lg.tm.zoom", function (a, b) {
        ...
        d.dblclick(function (a) {
          var f,
            h = d.width(),
            i =
              c.core.$items.eq(b).attr("data-width") || d[0].naturalWidth || h;
        ...
        a.core.$slide.on("touchstart.lg", function (c) {
          ...
          a.core.$slide.on("touchmove.lg", function (g) {
            if (a.core.$outer.hasClass("lg-zoomed")) {
              ...
              g.preventDefault(),
                (d = !0),
                (c = g.originalEvent.targetTouches[0].pageX),
                (c = {
